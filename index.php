        ...
        <div class="row">
          ...
          <div class="col-lg-4">
            <div class="testimonial-item mx-auto mb-5 mb-lg-0">
              ...
              <h5>Katherine S.</h5>
              <p class="font-weight-light mb-0">"Incrível. Tenho usado o sistema em minha empresa e o control."</p>
            </div>
          </div>
          <div class="col-lg-4">
            <div class="testimonial-item mx-auto mb-5 mb-lg-0">
      ...
      <div class="container">
        <div class="row">
          <div class="col-xl-9 mx-auto">
            <h2 class="mb-4">Pronto para começar? Faça seu login agora mesmo!</h2>
          </div>
          ...
          <div class="col-lg-6 h-100 text-center text-lg-right my-auto">
            <ul class="list-inline mb-0">
              <li class="list-inline-item mr-3">
                <a href="#">
                  <i class="fas fa-phone fa-2x fa-fw text-success"></i>
                </a>
              </li>
              <li class="list-inline-item mr-3">
                <a href="#">
                  <i class="fab fa-whatsapp fa-2x fa-fw text-success"></i>
                </a>
              </li>
              <li class="list-inline-item">
                <a href="#">
                  <i class="fab fa-google fa-2x fa-fw text-success"></i>
                </a>
              </li>
            </ul>
          </div>
